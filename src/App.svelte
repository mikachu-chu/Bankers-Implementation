...
>
  ...
  <div
    class="fixed bottom-0 shadow-xl bg-[#431259]/10 sm:bg-transparent w-screen justify-center text-xs sm:text-sm h-8 sm:h-10 items-center flex gap-2"
  >
    <a
      class="btn-circle btn h-6 w-6 bg-black text-white flex contents-center border-0"
      aria-label="button"
      type="button"
      href="https://github.com/mikachu-chu"
      ><i class="ri-github-fill sm:scale-110"></i></a
    >
